    ...
    <form action="{{ route('membro.editar',['id' => $pessoa->id]) }}" method="post">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="funcao" value="{{ $pessoa->funcao }}" readonly >
            </div>
            <div class="form-group col-md-4">
                <label for="flag_status">Estado:</label>
                <select name="flag_status" class="form-control" id="flag_status" value="{{ $pessoa->status }}" readonly > 
